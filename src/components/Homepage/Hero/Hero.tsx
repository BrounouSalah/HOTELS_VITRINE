        ...
        <VStack mb="20" spacing={20} alignItems="center">
          <VStack pt={["10", "20"]} spacing="6" w="full">
            <Heading
              ...
              data-aos="fade-up"
            >
              Simplifiez la gestion hôtelière avec _HOTELS
            </Heading>
            <Text
              fontSize={["lg", "xl"]}
              maxW="800px"
              ...
              data-aos-delay="100"
            >
              Gérez les réservations, les tarifs, les services, les dépenses et
              le personnel – tout sur une seule plateforme.
            </Text>
            <Stack
      ...
      <Flex justify="center" bgGradient="linear(to-b, gray.900, gray.800)">
        <VStack spacing="12" pb="32" maxW="7xl" px={4}>
          <Heading fontSize="25px" fontWeight="semibold" data-aos="fade">
            Système de gestion hôtelière tout-en-un
          </Heading>
          <Text
            fontSize={["lg", "xl"]}
            maxW="800px"
            ...
            data-aos-delay="100"
          >
            _HOTELS facilite la gestion de toutes les opérations hôtelières à
            partir d'une seule interface. Gérez vos réservations, suivez vos
            dépenses et ajustez vos tarifs grâce à des règles dynamiques.
            Optimisez la gestion de votre hôtel tout en économisant du temps et
            des ressources.
          </Text>
          {/* <SimpleGrid
            columns={{ base: 2, md: 4 }}
